...
export declare const devtools: <S extends object, CustomSetState extends SetState<S>, CustomGetState extends GetState<S>, CustomStoreApi extends StoreApiWithDevtools<S>>(fn: (set: NamedSet<S>, get: CustomGetState, api: CustomStoreApi) => S, options?: string | {
...
} | undefined) => (set: CustomSetState, get: CustomGetState, api: CustomStoreApi & {
    dispatch?: unknown;
}) => S;
...
export declare const subscribeWithSelector: <S extends object, CustomSetState extends SetState<S>, CustomGetState extends GetState<S>, CustomStoreApi extends StoreApiWithSubscribeWithSelector<S>>(fn: (set: CustomSetState, get: CustomGetState, api: CustomStoreApi) => S) => (set: CustomSetState, get: CustomGetState, api: CustomStoreApi) => S;
